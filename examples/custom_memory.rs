//! Example: Implementing a custom Memory backend for Jarvis
//!
...
// ── Re-define the trait types (in your app, import from jarvis::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Jarvis Memory Demo — InMemoryBackend\n");
