...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/Afee2019/jarvis/security/advisories/new)
...
Jarvis implements defense-in-depth security:
...
Jarvis Docker images follow CIS Docker Benchmark best practices:
...
docker inspect --format='{{.Config.User}}' jarvis
# Expected: 65534:65534

# Run with read-only filesystem (production hardening)
docker run --read-only -v /path/to/workspace:/workspace jarvis gateway
```
